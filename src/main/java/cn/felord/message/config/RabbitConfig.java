...
//        开启returncallback     yml 需要 配置    publisher-returns: true
    ...
    public Exchange deadLetterExchange() {
        return ExchangeBuilder.directExchange("A").durable(true).build();
    }
...
//       x-dead-letter-exchange    声明  死信交换机 为交换机A
        args.put(DEAD_LETTER_QUEUE_KEY, "A");
//       x-dead-letter-routing-key    声明 死信路由键
    ...
    public Binding deadLetterBinding() {
        return new Binding("DL_QUEUE", Binding.DestinationType.QUEUE, "A", "DL_KEY", null);
    ...
    public Binding redirectBinding() {
        return new Binding("REDIRECT_QUEUE", Binding.DestinationType.QUEUE, "A", "KEY_R", null);
    }
